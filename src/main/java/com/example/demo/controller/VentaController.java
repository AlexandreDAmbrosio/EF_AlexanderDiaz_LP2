...
public class VentaController {
	...
	public void InsertarCiudades() {
		...
		ListaCiudades.add(new Ciudad("CIUD001", "LIMA"));
		ListaCiudades.add(new Ciudad("CIUD002", "AREQUIPA"));
		ListaCiudades.add(new Ciudad("CIUD003", "TRUJILLO"));
		ListaCiudades.add(new Ciudad("CIUD004", "ICA"));
		ListaCiudades.add(new Ciudad("CIUD005", "CHICLAYO"));
		ListaCiudades.add(new Ciudad("CIUD006", "TACNA"));
		ListaCiudades.add(new Ciudad("CIUD001", "MOQUEGUA"));

		for (int i = 0; i < ListaCiudades.size(); i++) {
			serviceCiudad.Guardar(ListaCiudades.get(i));
		}
	}
